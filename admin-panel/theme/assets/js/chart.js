        ...
        datasets: [
          {
            ...
            data: [980, 540, 100, 150],
            backgroundColor: ["#ff0000", "#29cc97", "#8061ef", "#fec402"],
            borderWidth: 1
    ...
    if (polar !== null) {
      var configPolar = {
        data: {
          ...
          labels: ["Erangos", "Hoppy", "Look Behind!", "SRace", "Lethal League"]
        },
        options: {
          responsive: true,
          maintainAspectRatio: false,
  ...
  var myChart = new Chart(barX, {
    ...
    data: {
      ...
      datasets: [
        {
          label: "signup",
          data: [100, 123, 531, 445, 322, 98, 402, 611, 228, 341, 323, 1000],
          // data: [2, 3.2, 1.8, 2.1, 1.5, 3.5, 4, 2.3, 2.9, 4.5, 1.8, 3.4, 2.8],
          backgroundColor: "#4c84ff"
        }
      ]
